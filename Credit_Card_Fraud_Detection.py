...
# ### Displaying first few rows of the dataset to ensure it's loaded correctly
...
# ### Checking the missing vales in the dataset
...
# Train the model
nn_model.fit(X_train_temp, y_train_temp, epochs=10, batch_size=64, validation_data=(X_val, y_val))

# Predict on the test data
y_pred_test_nn = nn_model.predict(X_test).ravel()
y_pred_test_nn = (y_pred_test_nn > 0.5).astype(int)
